...
class TabsItem {
  ...
  select() { this.element.classList.add("projects-tab-item-selected"); }

  deselect() { this.element.classList.remove("projects-tab-item-selected"); }
}

// setup the tabs under the services page
let tabs = document.querySelectorAll(".projects");
